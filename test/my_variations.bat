...
::py create_map_poster.py -c "Ho Chi Minh city" -dc "Thành phố Hồ Chí Minh" -C "Vietnam" -dC "Việt Nam" -t mohe_subaraya_light -d 40000 -iO -iR --font-family "Playfair Display" -W 16 -H 12
::py create_map_poster.py -c "Ho Chi Minh city" -dc "Thành phố Hồ Chí Minh" -C "Vietnam" -dC "Việt Nam" -t japanese_ink -d 40000 -iO -iR --font-family "Playfair Display"
...
::py create_map_poster.py -c "Nürburgring" -C "Germany" -t grand_prix_dimmed -d 15000 --font-family "Russo One" -lat 50.34765 -long 6.96651
